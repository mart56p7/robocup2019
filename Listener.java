...
public class Listener extends AbstractNodeMain {
  ...
  public void onStart(ConnectedNode connectedNode) {
    ...
    Subscriber<std_msgs.Int32> subscriber = connectedNode.newSubscriber("Robo2019", std_msgs.Int32._TYPE);
    subscriber.addMessageListener(new MessageListener<std_msgs.Int32>() {
      @Override
      public void onNewMessage(std_msgs.Int32 message) {
        log.info("I heard something new and exciting! it was: \"" + Integer.toString(message.getData()) + "\"");
      }
    });
  }
}
